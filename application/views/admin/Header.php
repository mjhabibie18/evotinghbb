...
<html>
<head>
	<title>TRILOGI E-Voting</title>
	<link rel="icon" href="pictures/11.png" type="pictures/png">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.8/js/materialize.min.js"></script>
	...
	<nav>
		<div class="nav-wrapper #1a237e indigo darken-4">
			<div class="container #1a237e indigo darken-4">
				<a href="<?php echo site_url('admin')?>" class="brand-logo"><img src="pictures/ok.jpg" alt="" class="responsive-img" style="height: 55px; padding-top: 6px;"></a>
				<ul class="right hide-on-med-and-down">
					<li><a href="<?php echo site_url('Admin/pesan');?>" class="valign-wrapper"> 
					<i class="material-icons">forum</i>Pesan</a></li>
					<li><a href="<?php echo site_url('Admin/startvoting');?>" class="valign-wrapper"> 
					<i class="material-icons">touch_app</i>Start Voting</a></li>
					 <li><a class="dropdown-button valign-wrapper" href="#!" data-activates="dropdown1" data-beloworigin="true">
			              ...
			              <ul id='dropdown1' class='dropdown-content' href="#!" data-activates="dropdown1" data-beloworigin="true">
			                    ...
			                    <li><a href="<?php echo site_url('user')?>" class="blue-text">Login sebagai Pemilih</a></li>
