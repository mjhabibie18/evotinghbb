		...
		<div class="card black-text">
			<div class="card content">
				<div class="row">
					<div class="col s12">
					    <ul class="tabs ">
					        <li class="tab col s3"><a href="#profile" class="black-text">Profil Info</a></li>
					         <li class="tab col s3"><a href="#info" class="black-text">Update Info</a></li>
					        <li class="tab col s3"><a href="#akun" class="black-text">Update Akun</a></li>
					        <li class="tab col s3"><a href="#photo" class="black-text">Update Photo</a></li>
					    </ul>
					    </div>
								        ...
								        <div class="input-field col s12">
								         ...
								         <div class="input-field col s12">
										    <select name="jurusan" id="jurusan">
										      <option value="" disabled selected>Pilih Jurusan</option>										    <option value="Teknik Informatika">Teknik Informatika</option>
										 ...
										 <button class="btn waves-effect waves-light #1a237e indigo darken-4 submit1" type="submit" name="action">Update
										  </button>
										  <button class="btn waves-effect waves-light #1a237e indigo darken-4" type="reset" name="action">Cancel
										  </button>		 
									</div>
					 			</div>
					 			<?php echo form_close();?>
						...
						<?php echo form_open();?>
							...
							<div class="col s6 offset-s3">
								    <div class="row">
								     ...
								     <button class="btn waves-effect waves-light #1a237e indigo darken-4 submit2" type="submit" name="action">Update
										  </button>
										  <button class="btn waves-effect waves-light #1a237e indigo darken-4" type="reset" name="action">Cancel
										  </button>	
							</div>
							...
							<div class="col s4 " style="margin-left: 40px">
								...
								<div class="col s6">
									<div class="file-field input-field" id="imgName">
									 ...
									 <div class="center">
									 	<button class="btn waves-effect waves-light #1a237e indigo darken-4 submit3" type="submit" name="action">Update
										  </button>
									 </div>
								</div>	
							</div>
