				...
				<div class="row">
					<div class="col s12">
					    <ul class="tabs ">
					        ...
					        <li class="tab col s3"><a href="#akun">Update Akun</a></li>
					  			...
					  			<div class="col s6 offset-s3">
								     <div class="row">
								        ...
								        <div class="input-field col s12">
										 ...
										 <button class="btn waves-effect waves-light #1976d2 blue darken-2 submit1" name="action">Update
										  </button>
						...
						<?php echo form_open();?>
							...
							<div class="col s6 offset-s3">
								    <div class="row">
								    	<div class="input-field col s12">
								          <i class="material-icons prefix">account_circle</i>
								          <input id="icon_prefix" type="text" class="validate" name="nim" value="<?php echo $nim;?>" readonly>
								     ...
								     <button class="btn waves-effect waves-light #1976d2 blue darken-2 submit2" name="action">Update
										  </button>
										  <button class="btn waves-effect waves-light #1976d2 blue darken-2" type="reset" name="action">Cancel
										  </button>	
							</div>
						...
						<?php echo form_open_multipart('user/photo');?>
							<div class="row">
...
$(document).ready(function() {
			...
			jQuery.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>"+"user/update_info",
			dataType: 'json',
...
$(document).ready(function() {
			...
			jQuery.ajax({
			type: "POST",
			url: "<?php echo base_url();?>"+"user/update_akun",
			dataType: 'json',
			data: {pass: pass},
			success: function(res) {
				if(res.hasil == 'true'){
